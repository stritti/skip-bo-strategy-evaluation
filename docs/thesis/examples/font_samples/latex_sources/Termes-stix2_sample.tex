...
%	pdfversion  = 2.0,   % default version
	...
	tagging		= on, % For tagging (accessible PDF), run lualatex with TeX Live 2025 or later.
					  % Do not include appendixa.tex when selecting this option (crash may result).
}

%%%%%%%%%  Documentclass and options  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\documentclass[fontset=termes-stix2]{mitthesis}% fontset=libertinus, fontset=lmodern, fontset=lucida, 
